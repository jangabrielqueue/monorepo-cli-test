...
const API_DEPOSIT_CRYPTO_REQUEST = '/api/crypto/deposit'
...
export async function sendDepositCryptoRequest (data) {
  try {
    const rsp = await axios.post(API_DEPOSIT_CRYPTO_REQUEST, {
      ...data,
      key: data.signature,
      customer: data.requester
    })
