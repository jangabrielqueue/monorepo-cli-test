...
const Deposit = (props) => {
  ...
  const hasNotifications = bank === "VCB";
  const wrapperStyles = hasNotifications
    ? "wrapper wrapper-with-notifications"
    : "wrapper wrapper-without-notifications";

  return (
    <WrapperBG className={wrapperStyles} color={themeColor}>
          ...
          <div className="deposit-submit-buttons">
            <GlobalButton
              ...
              icon={
                <img
                  alt="sms"
                  src={require(`../../assets/icons/${renderIcon.toLowerCase()}/sms-${renderIcon.toLowerCase()}.svg`)}
                />
              }
            ...
            <GlobalButton
              ...
              icon={
                <img
                  alt="smart"
                  src={require(`../../assets/icons/${renderIcon.toLowerCase()}/smart-${renderIcon.toLowerCase()}.svg`)}
                />
              }
              onClick={handleSubmit((values, e) =>
